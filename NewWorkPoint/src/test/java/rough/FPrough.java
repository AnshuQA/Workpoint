...
public class FPrough {

	public static void main(String[] args) throws InterruptedException {
		WebDriverManager.chromedriver().setup();
		WebDriver driver = new ChromeDriver();

		driver.get("https://uat-workpoint.azurewebsites.net/login");
		...
		Thread.sleep(15000);
		driver.get("https://uat-workpoint.azurewebsites.net/lead");
...
//FP Button
		...
		driver.findElement(By.xpath(
				"/html/body/app-root/app-workpoint-layout/div[1]/div/div[1]/div[2]/ng-component/div[1]/div[3]/div/div/div/div[2]/div[2]/div[1]/div/div[3]/a"))
				.click();
...
// If plan Already Added 
		if (driver.findElement(By.xpath(
				"//body/app-root[1]/app-financialplan-layout[1]/ng-component[1]/div[3]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/input[1]"))
				.isDisplayed()) {
			Thread.sleep(3000);
			driver.findElement(By.xpath(
					"//body/app-root[1]/app-financialplan-layout[1]/ng-component[1]/div[3]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/input[1]"))
					.sendKeys("Automation Test Planning");
...
// Edit Button
		...
		if (sizea > 0) {
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath(
					"//body/app-root[1]/div[1]/ng-component[1]/div[16]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/button[1]"))
					.click();

		}

		// Basic Details //Marital Status Thread.sleep(3000);
		...
		Thread.sleep(3000);
		WebElement wife = driver.findElement(By.id("wifeclientName"));
		wife.clear();
		wife.sendKeys("Test Wife");
		Thread.sleep(3000);
		...
		// Children Details
		int size02 = driver.findElements(By.id("childclientName0")).size();
		if (size02 > 0) {
			WebElement child1 = driver.findElement(By.id("childclientName0"));
			child1.clear();
			child1.sendKeys("testChild1");

			Thread.sleep(3000);
			WebElement child2 = driver.findElement(By.id("childclientName1"));
			child2.clear();
			child2.sendKeys("Test Child 2nd");
			Thread.sleep(3000);
			WebElement dob = driver.findElement(By.id("childage1"));
			dob.clear();
			dob.sendKeys("15");
			...
			driver.findElement(By.xpath("//*[@id=\"child-field\"]/div[1]/div[6]/span/input")).click();
			...
			driver.findElement(By.xpath("//*[@id=\"child-field\"]/div[2]/div[6]/span/input")).click();
		}
		...
		Thread.sleep(3000);
		driver.findElement(By.id("wifedob")).sendKeys(Keys.PAGE_DOWN);
		int size2 = driver.findElements(By.id("guardianclientName0")).size();
		if (size2 > 0) {
			WebElement father = driver.findElement(By.id("guardianclientName0"));
			father.clear();
			father.sendKeys("Shitla Prasad Singh");

			Thread.sleep(3000);
			WebElement mother = driver.findElement(By.id("guardianclientName1"));
			mother.clear();
			mother.sendKeys("Shiv Kumari");
			Thread.sleep(5000);
			...
			driver.findElement(By.id("wifedob")).sendKeys(Keys.PAGE_DOWN);
			Thread.sleep(3000);
			driver.findElements(By.id("append-child-form")).get(1).click();
		...
		try {
			int i = 0;
			while (i <= 10) {
				int sizea1 = driver.findElements(By.xpath(
						"//body[1]/app-root[1]/app-financialplan-layout[1]/ng-component[1]/section[2]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/table[1]/thead[1]/tr[1]/th[9]/a[2]/i[1]"))
						.size();
				if (sizea1 > 0) {
					...
					driver.findElement(By.xpath(
							...
							.click();
					driver.findElement(By.xpath(
							"//body/app-root[1]/app-financialplan-layout[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/button[1]"))
							.click();
					Thread.sleep(4000);
					i++;
		...
		Thread.sleep(3000);
		WebElement currentAge = driver.findElement(By.id("currentAge_RetdFund"));
		currentAge.clear();
		currentAge.sendKeys("26");
		Thread.sleep(3000);
		...
		studyn.selectByVisibleText("testChild1");
		Thread.sleep(3000);
		driver.findElement(By.id("present_Value")).sendKeys("12000");
		Thread.sleep(3000);
		driver.findElement(By.id("startDate")).sendKeys("10-08-2022");
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"profileupdateBasic\"]/div/div/div/div[2]/div[1]/ul/li[2]/a")).click();
		int sizea1 = driver.findElements(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[2]/div/div/div/div[2]/div/table/tbody/tr[1]/td[5]/a[2]/i"))
				.size();
		if (sizea1 > 0) {
			JavascriptExecutor js011 = (JavascriptExecutor) driver;
			js011.executeScript("window.scrollBy(0,1000)");
			Thread.sleep(3000);
			driver.findElement(By.xpath(
					"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[2]/div/div/div/div[2]/div/table/thead/tr/th[1]/input"))
					.click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//button[contains(text(),'Delete All Income')]")).click();
			driver.findElement(By.xpath(
					"/html/body/app-root/app-financialplan-layout/ng-component/div[2]/div/div/div/div/div[2]/button[1]"))
					.click();
		}
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[1]/ul/li[3]/a"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//button[contains(text(),'Upload File')]")).sendKeys(Keys.DOWN);
		int sizea01 = driver.findElements(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[2]/div/div/div/div[2]/div/table/tbody/tr[1]/td[9]/a[2]/i"))
				.size();
		if (sizea01 > 0) {
			JavascriptExecutor js011 = (JavascriptExecutor) driver;
			js011.executeScript("window.scrollBy(0,1000)");
			Thread.sleep(3000);
			driver.findElement(By.id("selectIncomeFlag")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//button[contains(text(),'Delete All Mutual Funds')]")).click();
			driver.findElement(By.xpath(
					"/html/body/app-root/app-financialplan-layout/ng-component/div[4]/div/div/div/div/div[2]/button[1]"))
					.click();
		}
		...
		int sizea2 = driver.findElements(By.id("IsAddedInFP0")).size();
		if (sizea2 > 0) {

			driver.findElement(By.id("IsAddedInFP0")).click();
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"recomndationInsuId\"]/div/div/button[1]")).click();

		}
		int sizea3 = driver.findElements(By.id("IsAddedInFP1")).size();
		if (sizea3 > 0) {

			driver.findElement(By.id("IsAddedInFP1")).click();
		...
		Thread.sleep(10000);
		driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[1]/ul/li[4]/a"))
				.click();
		Thread.sleep(3000);
...
//****************** Step-5  Net Allocation ****************************************************************************************************************

		Thread.sleep(10000);
		driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[1]/ul/li[5]/a"))
				.click();
		Thread.sleep(8000);
		List<WebElement> list1 = driver.findElements(By.id("userGoalName"));
		list1.get(0).click();
		driver.findElement(By.xpath("//*[@id=\"assetAllocationId\"]/div[1]/div[1]/div[1]/table/tbody/tr[1]/td[1]"))
				.click();
		Thread.sleep(3000);
		driver.findElement(By.id("assetIdName")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("IsDeleteFP0")).click();
		driver.findElement(By.xpath("//*[@id=\"assetAllocationId\"]/div[1]/div[2]/div[1]/table/tbody/tr[1]/td/a[2]"))
				.click();
		...
		driver.findElement(By.xpath("//button[contains(text(),'Add')]")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"featureValueCalculate\"]/div[3]/input")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//button[contains(text(),'Add')]")).click();
		...
		driver.findElement(By.id("assetIdName")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("IsDeleteFP1")).sendKeys(Keys.PAGE_DOWN);
		WebElement element = driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[2]/div/div/div/div[1]/div/div[1]/div/form/div[1]/div[2]/div[1]/table/tbody/tr[5]/td[1]/input"));

		Actions actions = new Actions(driver);
		Thread.sleep(3000);
		actions.moveToElement(element).click().perform();
		// driver.findElement(By.id("IsDeleteFP1")).click();
		driver.findElement(By.xpath("//*[@id=\"assetAllocationId\"]/div[1]/div[2]/div[1]/table/tbody/tr[1]/td/a[2]"))
				.click();
		...
		// New asset
		Thread.sleep(5000);
		List<WebElement> list4 = driver.findElements(By.xpath("//input[@id='userGoalName']"));
		list4.get(0).click();
		driver.findElement(By.xpath("//td[contains(text(),'Retirement')]")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("assetIdName")).click();
		...
		WebElement element1 = driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[2]/div/div/div/div[1]/div/div[1]/div/form/div[1]/div[2]/div[1]/table/tbody/tr[4]/td[1]/input"));
...
//***********Step-6 Net Cash Flow Allocation******************************************************************************************************

		Thread.sleep(10000);
		driver.findElement(By.xpath(
				"/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div[2]/div[1]/ul/li[6]/a"))
				.click();
...
//Risk Recommendation
		...
		WebElement element007 = driver.findElement(By.xpath("//a[contains(text(),'Add')]"));
		je.executeScript("arguments[0].scrollIntoView(true);", element007);
		element007.click();

//**********************Genarate Fincial Plan***********************************************************************
		Thread.sleep(5000);
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
		js1.executeScript("scroll(0, 1000)");
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"RiskSelection\"]/div[3]/div/div/div[2]/a")).click();

//**********************SUMMARY VIEW***********************************************************************************			

		/*
		 * Thread.sleep(5000); ArrayList<String> tabs1 = new
...
//Cash Inflow & Outflow
		Thread.sleep(8000);
		driver.findElement(
				By.xpath("/html/body/app-root/app-financialplan-layout/ng-component/section[2]/div/div/div/div/a"))
				.click();
...
//Available Resoureces
		Thread.sleep(8000);
		driver.findElement(By.xpath(
				"//body/app-root[1]/div[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[2]/ul[1]/li[3]/a[1]"))
				.click();
		...
		Thread.sleep(8000);
		driver.findElement(By.xpath(
				"//body/app-root[1]/div[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[2]/ul[1]/li[4]/a[1]"))
				.click();
...
//revised-cash-inflow-outflow
		...
		Thread.sleep(8000);
		driver.findElement(By.xpath(
				"//body/app-root[1]/div[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[2]/ul[1]/li[5]/a[1]"))
				.click();
...
//scheme-selection
		...
		Thread.sleep(8000);
		driver.findElement(By.xpath(
				"//body/app-root[1]/div[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[2]/ul[1]/li[6]/a[1]"))
				.click();
...
//plan-assumptions
		...
		Thread.sleep(8000);
		driver.findElement(By.xpath(
				"//body/app-root[1]/div[1]/ng-component[1]/div[1]/div[1]/div[1]/div[1]/aside[1]/div[2]/ul[1]/li[7]/a[1]"))
				.click();
